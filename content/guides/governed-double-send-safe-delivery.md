...
**Reference:** the claim-and-lock primitive this pipeline leans on is [PostgreSQL's `SELECT ... FOR UPDATE` / `SKIP LOCKED`](https://www.postgresql.org/docs/current/sql-select.html).
