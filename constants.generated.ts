...
//
// Initial seed (2026-06-08): the 6 hardcoded thoughts that previously
// lived inline in constants.ts. While substrate yields 0 matching
// canonicals, scripts/compileContent.ts is a fail-open no-op and these
// seed entries continue to render. See AGENTS.md for the
// substrate-consumer contract and migration posture.
