...
export const RESOURCES: Resource[] = [
  // L1 — Authority Gate
  {
    ...
    enforcementLayer: 1,
    riskDomain: "Regulatory exposure — audit indefensibility from ungoverned execution paths",
    gated: true,
  ...
  },
  {
    ...
    enforcementLayers: [1, 2, 3, 4],
    enforcementLayer: 1,
    riskDomain: "Deployment friction — no structured path from gap identification to enforcement",
    gated: false,
  ...
  // L2 — Immutable Receipts
  {
    ...
    enforcementLayers: [1, 2, 3, 4],
    enforcementLayer: 2,
    riskDomain: "Irreversible state change — mutations without cryptographic attestation",
    gated: true,
  ...
  },
  {
    ...
    enforcementLayers: [1, 2, 3, 4],
    enforcementLayer: 2,
    riskDomain: "Financial impact — uncontrolled execution without attestation trail",
    gated: false,
  ...
  // L3 — Drift Guard
  {
    ...
    enforcementLayers: [1, 2, 3, 4],
    enforcementLayer: 3,
    riskDomain: "Operational blast radius — compounded deviation from unconstrained autonomous behavior",
    gated: false,
  ...
  // L4 — Gated Substrate
  {
    ...
    enforcementLayers: [1, 2, 3, 4],
    enforcementLayer: 4,
    riskDomain: "Escalation rate — intelligence routing itself without substrate containment",
    gated: false,
